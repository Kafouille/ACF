...
ACF_defineGun("20mmHMG", { --id
	...
	desc = "The lightest of the HMGs, the 20mm fires at a high rate, but with poor accuracy and little damage.  Often used to strafe ground troops or annoy low-flying aircraft.",
...
ACF_defineGun("30mmHMG", {
	...
	desc = "30mm shell chucker, light and compact, however suffers in accuracy and ballistics. Best used in aircraft, it lobs a solid amount of lead out a respectable distance.",
